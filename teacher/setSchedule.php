            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">SET SCHEDULES</h4>
                  <div class="row mt-3">
              ...
              <div class="card-body">
               <!--  <form role="form" class="text-start"> -->
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="date" name="schedule_date" id="schedule_date" class="form-control" placeholder="date" required>
                  </div>
                    <center><p style="color: #ff0000; font-weight: bold; font-size: 12px;" id ="dateerror"> </p></center>
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label"></label>
                    <input type="time" name="timestart" id="timestart" class="form-control" placeholder="Time Start" required>
                  </div>
                  <center><p style="color: #ff0000; font-weight: bold; font-size: 12px;" id ="timestarterror"> </p></center>
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label"></label>
                    <input type="time" name="timeend" id="timeend" class="form-control" placeholder="Time End" required>
                    <input type="hidden" name="t_id" id="t_id" class="form-control" value="<?php echo $_SESSION['t_id'];?>">
                  ...
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label"></label>
                    <textarea type="text" class="form-control" id="description" name="description" required="" placeholder="Details/Notes"></textarea>
                  </div>
                   <center><p style="color: #ff0000; font-weight: bold; font-size: 12px;" id ="descriptionerror"> </p></center>
                  <div class="text-center">
                    <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2" onclick="setSchedule()">Save</button>
