...
$result = $teacher->getTeacherBookings();
                     ...
                     <?php if($result)
                            ...
                            <tr>
                              ...
                              <td >
                                ...
                                <a href="#" onclick="startMeeting('<?php echo $row['b_id']?>')" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                  Start |
                                </a>
                               <?php } if($row['status'] == 'inprocess'){ ?> 
                                     <a href="#"onclick="endMeeting('<?php echo $row['b_id']?>','<?php echo $row['appoint_id']?>','<?php echo $row['u_type']?>')" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                  End |
                                </a>
                                <?php } ?> 
                                 <?php  if($row['mode'] == 'chat' && $row['status'] != 'done'){ ?> 
                                     <a href="#" onclick="addChat('<?php echo $row['b_id']?>');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                       Chat
                                    </a>
                                <?php } ?> 
                                 <?php  if($row['status'] == 'done' && ($row['reason']==Null || empty($row['reason']))   ) { ?> 
                                     <a href="#" onclick="addRemarks('<?php echo $row['b_id']?>');" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                       Add Remarks
                                    </a>
                                <?php } ?> 
