              ...
              <div class="card-body">
               <!--  <form role="form" class="text-start"> -->
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label"></label>
                      <input type="text" name="username" id="username" class="form-control" onkeyup="scanUsernameTeacher();" placeholder="Username/Teacher ID" required >
                    </div>
                     <center><p style="color: #ff0000; font-weight: bold; font-size: 12px;" id ="usernameerror"> </p></center>
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label"></label>
                      <input type="email" id="email" name="email" class="form-control" placeholder="Email" onkeyup="scanTeacherMail();" required>
                    </div>
                  ...
                  <div class="text-center">
                    <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2" id="reg_btn" name="reg_btn" onclick="teacherValidate()">Sign Up</button>
                  </div>
