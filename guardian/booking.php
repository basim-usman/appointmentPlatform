              ...
              <div class="card-body">
               <!--  <form role="form" class="text-start"> -->
                <div class="input-group input-group-outline my-3">
                  ...
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label"></label>
                    <input type="time" name="timestart" id="stimestart" class="form-control" placeholder="Time Start" onchange ="validateAppointmentTimeGuardian()" required>
                  </div>
                  ...
                  <div class="text-center">
                    <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2" onclick="bookScheduleGuardian()">BOOK NOW</button>
