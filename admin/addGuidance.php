            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                  <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="text" name="last_name" id="last_name" class="form-control" placeholder="Full Name"  required>
                  ...
                  <div class="text-center">
                    <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2" id="reg_btn" onclick="addGuidance()">Save</button>
