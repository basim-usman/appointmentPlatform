      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Add News</a></li>
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Add News</h4>
                  <div class="row mt-3">
               ...
               <!--  <form role="form" class="text-start"> -->
                <div class="input-group input-group-outline my-3">
                    ...
                    <input type="hidden" name="a_id" id="a_id" value="<?php echo $_SESSION['a_id'];?>">
                     <textarea type="text" class="form-control" id="title" name="title" required="" placeholder="News Headline"></textarea>
                  </div>
                    <center><p style="color: #ff0000; font-weight: bold; font-size: 12px;" id ="titleerror"> </p></center>
 
                 
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label"></label>
                   <textarea type="text" class="form-control" id="solution" name="solution" required="" placeholder="News Details" rows="20"></textarea>
                  </div>
                  ...
                  <center><p style="color: #ff0000; font-weight: bold; font-size: 12px;" id ="solutionerror"> </p></center>
                  <div class="text-center">
                    <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2" id="reg_btn" onclick="addNews()">Save</button>
